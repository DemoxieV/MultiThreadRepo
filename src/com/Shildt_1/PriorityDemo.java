...
public class PriorityDemo {
    public static void main(String[] args) {
        ...
        System.out.println("Счетчик 1-ого потока с обычным приоритетом: "+mt3.count);
        System.out.println("Счетчик 2-ого потока с обычным приоритетом: "+mt4.count);
        System.out.println("Счетчик 3-ого потока с обычным приоритетом: "+mt5.count);
