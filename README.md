# MultiThreadRepo
## **Теория и практика Java Core. Всё про многопоточное программирование**
...
**Основная тема:** "Многопоточное программирование"

**Ключевые подтемы:**
- класс Thread, интерфейс Runnable;
- способы создания одного и нескольких потоков;
- фабричный метод;
- приоритеты и синхронизация потоков;
- приостановка, остановка и возобновление потоков;
- создание демон-потока;
- работа с основным потоком.
...
**Добавлено 3 альтернативных способа решений задач**
